...
DEPLOY_PATH=/Users/zlove/Documents/Github/maven-repository/repository
CURRENT_PATH=`pwd`
...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy -Dmaven.test.skip  -DaltDeploymentRepository=self-mvn-repo::default::file:/Users/zlove/Documents/Github/maven-repository/repository
